---
title: 'Integrating vMix with Esports Dash'
description: Learn how to integrate vMix with Esports Dash for real-time esports data. Follow our step-by-step guide to set up JSON data sources and display dynamic scores and stats.

alternates:
  canonical: /vmix-integration
---
import {Steps, Cards, Callout} from 'nextra/components'

# Add a Data Source to vMix for Esports
