...
description: Guide to install the EsportsDash Stream Deck plugin for seamless control of esports overlays and broadcasts.

alternates:
  canonical: /streamdeck/streamdeck-installation
---
...
Once you've installed the plugin, check out our [Stream Deck Actions](/streamdeck/streamdeck-controls) guide to learn about all available controls.