---
title: Match Tab
description: Master the Esports Dash Match Tab. Learn to manage game configurations, team settings, and scores for seamless esports broadcasts.
icon: LinkIcon

alternates:
  canonical: /user-interface/match-tab
---
