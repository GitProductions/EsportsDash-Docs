...
This would include the [sidebar](#side-navigation), [top navigation](#top-navigation) and the [footer](#status-bar--notifications).
<br/>
...
<Tabs items={['Side Navigation', 'Top Navigation', 'Status Bar']}>
