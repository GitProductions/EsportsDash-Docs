---
title: Main Window
description: Learn to use EsportsDash main window controls for managing overlays, scores, and tournament settings in esports broadcasts.
icon: LinkIcon

alternates:
  canonical: /user-interface/main-window
---
...
<Tabs items={['Side Navigation', 'Top Navigation', 'Status Bar', 'Content Area']}>
  ...
  <Tabs.Tab>
    ...
    - [**Show Info**](/user-interface/show-info-tab) ℹ️ - Manage broadcast information and caster details
    ...
    <Callout>
      The navigation bar can be collapsed to give you more workspace while maintaining quick access to all other tabs.
    </Callout>
  </Tabs.Tab>
