...
description: Learn how to install game configurations in Esports Dash. Follow our easy in-app or website steps to set up overlays and assets.

alternates:
  canonical: /install-game-configs
---
...
![In-App Installation Process](https://esportsdash.com/images/faq/install-game-config-app.webp)
...
![Website Installation Process](https://esportsdash.com/images/faq/install-game-config-website.webp)
